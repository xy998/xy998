...
def stats_svg(username, user, repos, languages):
    ...
    for index, (label, value) in enumerate(stat_items):
        ...
        y = 70 + row * 42
        cells.append(
            f'<circle cx="{x}" cy="{y - 5}" r="4" fill="#2d76b3"/>'
  ...
  <style>
    .title {{ font: 600 18px -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; fill: #333333; }}
    .label {{ font: 500 13px -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; fill: #555555; }}
    .value {{ font: 700 14px -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; fill: #333333; }}
    .meta {{ font: 500 12px -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; fill: #777777; }}
  </style>
...
def language_svg(username, languages):
  ...
  <style>
    .title {{ font: 600 18px -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; fill: #333333; }}
    .label {{ font: 500 13px -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; fill: #555555; }}
    .percent {{ font: 600 12px -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; fill: #333333; }}
    .meta {{ font: 500 12px -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif; fill: #777777; }}
  </style>
